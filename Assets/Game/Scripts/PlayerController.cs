...
public class PlayerController : NetworkBehaviour
{
    ...
    void Update()
    {
        ...
        {
            isReading = true;
            GameObject.Find("ingameTextCanvas").transform.Find("TextPanel").Find("Text").GetComponent<TMP_Text>().text = "Welcome! Thank you for signing up for the testing of our all-new harmless firearms! They may look mean but they don't actually hurt anything.\nAnyway, here's a little intro: we've transported you here to this maze for testing purposes, but don't worry! We have provided you with a handheld map for if you get lost. We apologize for the flickering lights, we couldn't figure out what was doing that, since during the refurbishment we replaced the original lighting. Seems like this place has an infinite source of energy.\nWe've also got a safeguard for when you inevitably get a lift to go down on top of you when you are underneath it. People these days.\n\n\nAnyway, have a great time! (don't get lost please, we need you to come back in order to gather data on your experience!)\n\n                          - CETC Co.";
        }
